...
// Import Data
d3.csv("/assets/data/data.csv").then(function(metroData) {
    ...
    var xLinearScale = d3.scaleLinear()
      .domain([8, d3.max(metroData, d => d.poverty)])
      .range([0, width]);

    var yLinearScale = d3.scaleLinear()
      .domain([4, d3.max(metroData, d => d.healthcare)])
      .range([height, 0]);
